<nav x-data="{ open: false }" class="bg-white border-b border-blue-400 shadow-md">
    <!-- Primary Navigation Menu -->
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 bg-blue-500 shadow-md">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('personas.index') }}" :active="request()->routeIs('personas.*')">
                        {{ __('Personas') }}
                    </x-jet-nav-link>
                </div>
